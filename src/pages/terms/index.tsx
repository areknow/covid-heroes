  ...
  return (
    <Column>
      ...
      <div className={styles.terms}>
        ...
        <p>Last updated: March 27, 2020</p>
        ...
        <ul>
          ...
          <li>
            ...
            "Us" or "Our" in this Agreement) refers to COVIDHEROES.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to COVIDHEROES, accessible from
            https://covidheroes.gives
          </li>
          <li>
        ...
        <ul>
          <li>By email: donate@covidheroes.gives</li>
        </ul>
      </div>
    </Column>
  );
